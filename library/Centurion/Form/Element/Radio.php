...
/**
 * This class allows you to create a radio button field
 */
class Centurion_Form_Element_Radio extends Zend_Form_Element_Radio
{
    /**
     * If an element can be display or not in a group
     * @var array
     */
    protected $_isAllowedPlacement = array('main', 'aside');
